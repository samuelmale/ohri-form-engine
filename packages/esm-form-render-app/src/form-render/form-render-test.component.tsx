...
import { OHRIForm, OHRIFormSchema, SessionMode, updateRequiredBehaviourByItent } from '@openmrs/esm-ohri-forms-lib';
...
function FormRenderTest() {
  ...
  const handleFormSubmission = e => {
    ...
    const processedJson = updateRequiredBehaviourByItent(formIntentInput, schemaInput);

    try {
      setSchemaOutput(JSON.stringify(processedJson, null, '  '));
      setFormInput(processedJson);
    } catch (err) {
